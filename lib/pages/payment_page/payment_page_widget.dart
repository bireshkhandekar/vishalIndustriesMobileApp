        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                          ...
                          Expanded(
                            ...
                            child: FutureBuilder<List<GetTotalpriceRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final textGetTotalpriceRowList = snapshot.data!;
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          12.0, 4.0, 12.0, 8.0),
                                                  child: Text(
                                                    'Take a screenshot of the payment confirmation. You\'ll need it on the next screen to place your order.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await launchURL(
                            'upi://pay?pa=bnk6227-1@okicici&pn=Biresh khandekar&mc=1234&tid=123456789012345&tr=1234ABCD5678&tn=Notes&am=1.00&cu=INR');
                      },
                      text: 'PROCEED',
              ...
              if (_model.checkbox2Value == true)
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.cashgettotalprice =
                            await SQLiteManager.instance.getTotalprice();
                        _model.cashAllget =
                            await SQLiteManager.instance.allget();
                        _model.apiResultorderplacecash =
                            await VIAPIsGroup.orderPlaceUPICall.call(
                          orderTotal:
                              _model.cashgettotalprice?.first.totalPrice,
                          paymentMethod: 'cash',
                          dealerId: FFAppState().users.dealerId,
                          userId: FFAppState().users.userId,
                          orderCreatedBy: FFAppState().users.displayName,
                          orderItemsJson: functions.convertToitem(
                              _model.cashAllget!.map((e) => e.itemid).toList(),
                              _model.cashAllget!
                                  .map((e) => e.quantity)
                                  .toList(),
                              _model.cashAllget!
                                  .map((e) => e.productName)
                                  .toList(),
                              _model.cashAllget!.map((e) => e.price).toList(),
                              _model.cashAllget!.map((e) => e.weight).toList()),
                          address: widget.address,
                        );

                        if ((_model.apiResultorderplacecash?.succeeded ??
                            true)) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                getJsonField(
                                  (_model.apiResultorderplacecash?.jsonBody ??
                                      ''),
                                  r'''$.message''',
                                ).toString(),
                                style: TextStyle(
              ...
              if ((_model.checkbox1Value == false) &&
