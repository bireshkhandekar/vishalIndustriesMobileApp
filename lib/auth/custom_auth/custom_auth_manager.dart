...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    vishalIndustriesAuthUserSubject.add(
      VishalIndustriesAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<VishalIndustriesAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  VishalIndustriesAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = VishalIndustriesAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    vishalIndustriesAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
VishalIndustriesAuthUser? currentUser;
