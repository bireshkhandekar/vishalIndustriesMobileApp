...
import 'productloading_model.dart';
export 'productloading_model.dart';
...
class _ProductloadingWidgetState extends State<ProductloadingWidget> {
  late ProductloadingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductloadingModel());
  }
                ...
                return [
                  () => Material(
                        ...
                        child: Container(
                          ...
                          height: MediaQuery.sizeOf(context).height * 0.406,
