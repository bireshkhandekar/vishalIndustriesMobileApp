...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD79105);
  late Color secondary = const Color(0xFF0000FF);
  late Color tertiary = const Color(0xFF4CAF50);
  late Color alternate = const Color(0xFF9C27B0);
  ...
  late Color accent3 = const Color(0xFF795548);
  late Color accent4 = const Color(0xFF607D8B);
...
class ThemeTypography extends Typography {
  ...
  String get displayLargeFamily => 'DM Serif Text';
  ...
  String get displayMediumFamily => 'DM Serif Text';
  ...
  String get displaySmallFamily => 'DM Serif Text';
  ...
  String get headlineLargeFamily => 'DM Serif Text';
  ...
  String get headlineMediumFamily => 'DM Serif Text';
  ...
  String get headlineSmallFamily => 'DM Serif Text';
  ...
  String get titleLargeFamily => 'DM Serif Text';
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF1976D2);
  late Color tertiary = const Color(0xFF388E3C);
  late Color alternate = const Color(0xFF7B1FA2);
  ...
  late Color accent3 = const Color(0xFF5D4037);
  late Color accent4 = const Color(0xFF455A64);
