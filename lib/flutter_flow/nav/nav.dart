...
class AppStateNotifier extends ChangeNotifier {
  ...
  VishalIndustriesAuthUser? initialUser;
  VishalIndustriesAuthUser? user;
  ...
  void update(VishalIndustriesAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/orderconfirmedPage',
          builder: (context, params) => OrderconfirmedPageWidget(
        ...
        FFRoute(
          name: 'connectionLossPage',
          path: '/connectionLossPage',
          builder: (context, params) => const ConnectionLossPageWidget(),
        ),
        FFRoute(
          name: 'useraddressPage',
          path: '/useraddressPage',
          builder: (context, params) => const UseraddressPageWidget(),
        ),
        FFRoute(
          name: 'AccountPage',
          path: '/accountPage',
        ...
        FFRoute(
          name: 'productLoading',
          path: '/productLoading',
          builder: (context, params) => const ProductLoadingWidget(),
        )
